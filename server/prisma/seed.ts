...
async function main() {
  ...
  console.log('\n📊 Summary:');
  console.log(`   - ${await prisma.clinic.count()} clinics`);
  console.log(`   - ${await prisma.doctor.count()} doctors`);
  console.log(`   - ${await prisma.secretary.count()} secretaries`);
  console.log(`   - ${await prisma.patient.count()} patients`);
  console.log(`   - ${await prisma.appointment.count()} appointments`);
  console.log(`   - ${await prisma.secretaryClinic.count()} secretary-clinic relations`);
